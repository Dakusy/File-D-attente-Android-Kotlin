...
import kotlinx.android.synthetic.main.activity_show__picture__conseil.btn_PairUnPair
import kotlinx.android.synthetic.main.activity_show__picture__conseil.btn_Retour
import kotlinx.android.synthetic.main.activity_show__picture__conseil.image_view
import kotlinx.android.synthetic.main.activity_show__picture__ordo.*
import java.io.ByteArrayOutputStream


class Show_Picture_Ordo : AppCompatActivity(), PrintingCallback {
        ...
        Picasso.get()
            ...
            .into(object : Target {
                ...
                override fun onBitmapFailed(e: Exception?, errorDrawable: Drawable?) {
                    Toast.makeText(this@Show_Picture_Ordo, "failed", Toast.LENGTH_SHORT).show()
                }
